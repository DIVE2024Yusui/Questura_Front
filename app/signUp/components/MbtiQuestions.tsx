...
const questions = [
  ...
  },
  {
    ...
    options: ["A) 구체적인 계획을 세우는 것", "B) 미래의 큰 흐름을 보는 것"],
    category: "SvsN",
  },
  {
    question:
...
export default function MbtiQuestions({
  ...
  return (
    <View>
      <Text style={styles.title}>MBTI 검사</Text>
